!function (t, n) {
    ...
    function I(t, n, e, r, o, i, u, s, a, l) {
        ...
        for (e.__k = [], c = 0; c < n.length; c++) if (null != (d = e.__k[c] = null == (d = n[c]) || "boolean" == typeof d ? null : "string" == typeof d || "number" == typeof d || "bigint" == typeof d ? k(null, d, null, null, d) : Array.isArray(d) ? k(S, {children: d}, null, null, null) : d.__b > 0 ? k(d.type, d.props, d.key, d.ref ? d.ref : null, d.__v) : d)) {
    ...
    function O(t, n, e, r, o, i, u, s) {
        ...
        if (null === h) p === d || s && t.data === d || (t.data = d); else {
            ...
            }(t, d, p, o, s), f) n.__k = []; else if (_ = n.props.children, I(t, Array.isArray(_) ? _ : [_], n, e, r, o && "foreignObject" !== h, i, u, i ? i[0] : e.__k && P(e, 0), s), null != i) for (_ = i.length; _--;) null != i[_] && w(i[_]);
    ...
    function Dt() {
        ...
        return x("div", {className: nt(et("search", null == (t = o.className) ? void 0 : t.search))}, x("input", {
            type: "search",
    ...
    function Rt() {
        var t = Et(), n = t.pagination, e = n.server, r = n.summary, o = void 0 === r || r, i = n.nextButton,
            u = void 0 === i || i, s = n.prevButton, a = void 0 === s || s, l = n.buttonsCount,
            c = void 0 === l ? 3 : l, f = n.limit, p = void 0 === f ? 10 : f, d = n.page, h = void 0 === d ? 0 : d,
            _ = n.resetPageOnUpdate, m = void 0 === _ || _, v = yt(null), g = vt(h), y = g[0], b = g[1], w = vt(0),
            k = w[0], N = w[1], P = Lt();
        gt(function () {
        ...
        return x("div", {className: et(nt("pagination"), t.className.pagination)}, x(S, null, o && k > 0 && x("div", {
            role: "status",
            "aria-live": "polite",
            className: et(nt("summary"), t.className.paginationSummary),
            title: P("pagination.navigate", y + 1, E())
        }, P("pagination.showing"), " ", x("b", null, P("" + (y * p + 1))), " ", P("pagination.to"), " ", x("b", null, P("" + Math.min((y + 1) * p, k))), " ", P("pagination.of"), " ", x("b", null, P("" + k)), " ", P("pagination.results"))), x("div", {className: nt("pages")}, a && x("button", {
            tabIndex: 0,
            role: "button",
            disabled: 0 === y,
            onClick: function () {
    ...
    var Gt =/*#__PURE__*/function (n) {
            ...
            return u.adjustWidth = function (t, n, e) {
                var o = t.container, u = t.autoWidth;
                if (!o) return this;
                var s = o.clientWidth, l = {};
                n.current && u && (q(x(Wt, {tableRef: n.current}), e.current), l = function (t) {
                    var n = t.querySelector("table");
                    if (!n) return {};
                    var e = n.className, o = n.style.cssText;
                ...
                for (var n, e = new i, r = a(t); !(n = r()).done;) {
                    var o = n.value;
                    if ("string" == typeof o || d(o)) e.columns.push({name: o}); else if ("object" == typeof o) {
                        var u = o;
    ...
    var en =/*#__PURE__*/function (t) {
        ...
        var e = {
            __c: n = "__cC" + m++, __: null, Consumer: function (t, n) {
                return t.children(n)
            }, Provider: function (t) {
                var e, r;
        ...
        return e.assign = function (t) {
            ...
            return "boolean" == typeof e.sort && e.sort && r.assign({sort: {multiColumn: !0}}), r.assign({header: Gt.createFromConfig(r)}), r.assign({storage: Jt.createFromConfig(r)}), r.assign({pipeline: an.createFromConfig(r)}), r.assign({translator: new It(r.language)}), r.search && r.plugin.add({
                id: "search",
    ...
    function dn(t) {
        ...
        return x("tr", {
            ...
            return o && o.hidden ? null : x(pn, {key: n.id, cell: n, row: t.row, column: o})
        }))
    }

    function hn(t) {
        return x(dn, {messageRow: !0}, x(pn, {
            role: "alert",
            colSpan: t.colSpan,
            messageCell: !0,
    ...
    function _n() {
        ...
        return x("tbody", {className: et(nt("tbody"), t.className.tbody)}, n && n.rows.map(function (t) {
        ...
        }), e === l.Error && x(hn, {message: o("error"), colSpan: i(), className: et(nt("error"), t.className.error)}))
    }
    ...
    var mn =/*#__PURE__*/function (t) {
        ...
        return r.validateProps = function () {
            ...
            for (var e, r = 0, o = a(this.props.columns); !(e = o()).done;) {
                var i = e.value;
                if (0 !== r) break;
                var u = t.cells[i.index].data, s = n.cells[i.index].data;
    ...
    function bn(t) {
        var n = Et(), e = Lt(), o = vt(0), i = o[0], u = o[1], s = vt(void 0), a = s[0], l = s[1], c = jt(function (t) {
            return t.sort
        ...
        var d = function () {
            var t = K.Sort;
            return p && "object" == typeof p.server && (t = K.ServerSort), 0 === n.pipeline.getStepsByType(t).length ? t === K.ServerSort ? new yn(r({columns: c ? c.columns : []}, p.server)) : new mn({columns: c ? c.columns : []}) : null
        };
        return x("button", {
            tabIndex: -1,
    ...
    function xn(t) {
        var n = Et(), e = yt(null), o = vt({}), i = o[0], u = o[1], s = Ht().dispatch;
        gt(function () {
        ...
        }, (a = t.column) ? "function" == typeof a.attributes ? a.attributes(null, null, t.column) : a.attributes : {}, l() ? {tabIndex: 0} : {}), x("div", {className: nt("th", "content")}, void 0 !== t.column.name ? t.column.name : void 0 !== t.column.plugin ? x($t, {
            pluginId: t.column.plugin.id,
            props: {column: t.column}
        }) : null), l() && x(bn, r({index: t.index}, t.column.sort)), t.column.resizable && t.index < n.header.visibleColumns.length - 1 && x(wn, {
            column: t.column,
            thRef: e
        }))
    }
            ...
            return function (t, n, r) {
                ...
                return x(dn, null, t.map(function (t) {
                    return t.hidden ? null : function (t, n, e, r) {
                        ...
                        return x(xn, {column: t, index: e, colSpan: o.colSpan, rowSpan: o.rowSpan})
                    }(t, n, o.indexOf(t), r)
                }))
            }(n, r, t.length)
        })) : null
    ...
    function Nn() {
        var t = Et(), n = yt(null), e = Ht().dispatch;
        return gt(function () {
            n && e(function (t) {
                return function (n) {
    ...
    function Pn() {
        var n = vt(!0), e = n[0], o = n[1], i = yt(null), u = Et();
        return gt(function () {
        ...
        }, x($t, {position: t.PluginPosition.Header})) : null
    }

    function Cn() {
        var n = yt(null), e = vt(!0), o = e[0], i = e[1], u = Et();
        return gt(function () {
        ...
        }, x($t, {position: t.PluginPosition.Footer})) : null
    }

    function En() {
        var t = Et(), n = Ht().dispatch, e = jt(function (t) {
            return t.status
        }), o = jt(function (t) {
            return t.data
        }), i = jt(function (t) {
        ...
        }, e === l.Loading && x("div", {className: nt("loading-bar")}), x(Pn, null), x("div", {
            className: nt("wrapper"),
            style: {height: t.height}
        }, x(Nn, null)), x(Cn, null), x("div", {ref: u, id: "gridjs-temp", className: nt("temp")}))
    }
