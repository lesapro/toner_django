...
myaccount_view = MyaccountView.as_view(template_name = "myaccounts/account.html")
account_settings_view = MyaccountView.as_view(template_name = "myaccounts/account-settings.html")
